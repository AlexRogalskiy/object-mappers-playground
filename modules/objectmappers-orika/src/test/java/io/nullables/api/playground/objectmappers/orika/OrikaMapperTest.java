...
import io.nullables.api.playground.objectmappers.orika.mapping.DeliveryDtoToEntityMapper;
...
class OrikaMapperTest {
    ...
    @BeforeEach
    void before() {
        this.mapperFacade = new DeliveryDtoToEntityMapper();
    }
    ...
    void testCheckDeliveryDtoConversion(@Nonnull final DeliveryDto source) {
        // when
        final DeliveryEntity target = this.mapperFacade.map(source, DeliveryEntity.class);
