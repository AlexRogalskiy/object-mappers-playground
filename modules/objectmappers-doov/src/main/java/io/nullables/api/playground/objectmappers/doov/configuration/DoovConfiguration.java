...
public class DoovConfiguration {

//    public JMapperAPI addressMappingApi() {
//        return new JMapperAPI().add(mappedClass(AddressEntity.class).add(global())
//            .add(
//                conversion("id").from("id").to("id").avoidSet(false).type(JMapConversion.Type.DYNAMIC)
...
//        return new JMapperAPI().add(mappedClass(DeliveryEntity.class).add(global())
//            .add(
//                conversion("id").from("id")
...
//            .add(
//                conversion("shippableDue").from("shippableDue").to("shippableDue").avoidSet(false).type(JMapConversion.Type.DYNAMIC)
