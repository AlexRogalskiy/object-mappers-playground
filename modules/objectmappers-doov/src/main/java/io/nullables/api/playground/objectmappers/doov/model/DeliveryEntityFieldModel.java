...
public class DeliveryEntityFieldModel extends RuntimeFieldRegistry<DeliveryEntity> {
	...
	public static final RuntimeField<DeliveryEntity, UUID> ID_TARGET = from(DeliveryEntity.class, ID)
			.readable("delivery identifier").field(DeliveryEntity::getId, DeliveryEntity::setId, UUID.class)
			.register(ALL);

	public static final RuntimeField<DeliveryEntity, Integer> TYPE_TARGET = from(DeliveryEntity.class, TYPE)
			.readable("delivery type").field(DeliveryEntity::getType, DeliveryEntity::setType, Integer.class)
			.register(ALL);

	public static final RuntimeField<DeliveryEntity, String> DESCRIPTION_TARGET = from(DeliveryEntity.class,
			DESCRIPTION).readable("delivery description")
					.field(DeliveryEntity::getDescription, DeliveryEntity::setDescription, String.class).register(ALL);

	public static final RuntimeField<DeliveryEntity, String> GID_TARGET = from(DeliveryEntity.class, GID)
			.readable("delivery globa identifier").field(DeliveryEntity::getGid, DeliveryEntity::setGid, String.class)
			.register(ALL);
	...
	public static final RuntimeField<DeliveryEntity, Date> CREATED_TARGET = from(DeliveryEntity.class, CREATE_AT)
			...
			.field(DeliveryEntity::getCreatedAt, DeliveryEntity::setCreatedAt, Date.class).register(ALL);
	...
	public static final RuntimeField<DeliveryEntity, Date> UPDATED_TARGET = from(DeliveryEntity.class, UPDATE_AT)
			...
			.field(DeliveryEntity::getUpdatedAt, DeliveryEntity::setUpdatedAt, Date.class).register(ALL);

	public static final RuntimeField<DeliveryEntity, LocalDateTime> SHIPPABLE_TARGET = from(DeliveryEntity.class,
			SHIPPABLE_DUE).readable("delivery shippable date")
	...
	public static final RuntimeField<DeliveryEntity, Double> BALANCE_TARGET = from(DeliveryEntity.class, BALANCE)
			.readable("delivery balance").field(DeliveryEntity::getBalance, DeliveryEntity::setBalance, Double.class)
			.register(ALL);
	...
	public static final RuntimeField<DeliveryEntity, BigDecimal> DISCOUNT_TARGET = from(DeliveryEntity.class, DISCOUNT)
			...
			.field(DeliveryEntity::getDiscount, DeliveryEntity::setDiscount, BigDecimal.class).register(ALL);
	...
	public static final RuntimeField<DeliveryEntity, DeliveryStatus> STATUS_TARGET = from(DeliveryEntity.class, STATUS)
			...
			.field(DeliveryEntity::getStatus, DeliveryEntity::setStatus, DeliveryStatus.class).register(ALL);
	...
	public static final RuntimeField<DeliveryEntity, List> ADDRESSES_TARGET = from(DeliveryEntity.class, ADDRESSES)
			...
			.field(DeliveryEntity::getAddresses, DeliveryEntity::setAddresses, List.class).register(ALL);

	public static final RuntimeField<DeliveryEntity, Integer[]> CODES_TARGET = from(DeliveryEntity.class, CODES)
			.readable("delivery codes").field(DeliveryEntity::getCodes, DeliveryEntity::setCodes, Integer[].class)
			.register(ALL);
