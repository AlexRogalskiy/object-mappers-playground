    ...
    public DoovMapperConfiguration configureDeliveryMappings() {
        this.mappings = this.mappings.with(
            ...
            map(DeliveryDtoFieldModel.SHIPPABLE_SOURCE)
                .using(converter(DateUtils::convertToLocalDateTime, "Converting shippable from <String> to <LocalDateTime>"))
            ...
            map(DeliveryDtoFieldModel.DISCOUNT_SOURCE)
                .using(converter(v -> StringUtils.convertToBigDecimal(v, BigDecimal.ZERO), "Converting discount from <String> to <BigDecimal>"))
            ...
            map(DeliveryDtoFieldModel.CODES_SOURCE)
                .using(converter(StringUtils::convertToIntegerArray, "Converting codes from <String> to <Integer> array"))
