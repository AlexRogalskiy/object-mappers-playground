...
public class LocalDateTimes extends MockUnitBase implements MockUnitLocalDateTime {
    ...
    public MockUnitLocalDateTime future(LocalDateTime maxDate) {
        ...
        isTrue(maxDate.compareTo(LocalDateTime.MAX.minusDays(1)) <= 0,
            MAX_DATE_NOT_BIGGER_THAN,
            "max", maxDate,
            "date", MAX.minusDays(1));
        isTrue(maxDate.plusDays(1).compareTo(LocalDateTime.now()) > 0,
    ...
    public MockUnitLocalDateTime past(LocalDateTime minDate) {
        ...
        isTrue(minDate.compareTo(LocalDateTime.MIN) > 0,
            MIN_DATE_BIGGER_THAN,
            "min", minDate,
            "date", MIN);
        isTrue(minDate.minusDays(1).compareTo(LocalDateTime.now()) < 0,
