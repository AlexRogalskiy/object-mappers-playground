...
class BeanMapperTest {
	...
	@BeforeEach
	void before() {
		this.deliveryMapper = BeanMapperConfigBuilder.newBuilder().withConverter(new StringToUuidConverter())
				.withConverter(new StringToBigDecimalConverter()).withConverter(new StringToIntegerArrayConverter())
				.withConverter(new StringToLocalDateTimeConverter()).build();
		this.addressMapper = BeanMapperConfigBuilder.newBuilder().withConverter(new StringToUuidConverter()).build();
	}
