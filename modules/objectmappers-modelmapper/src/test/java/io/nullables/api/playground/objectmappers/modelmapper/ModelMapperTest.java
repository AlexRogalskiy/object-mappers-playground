...
class ModelMapperTest {
    ...
    @BeforeEach
    void setUp() {
        this.modelMapper = ModelMapperBuilder.newBuilder()
            .withPropertyMap(new AddressDtoToAddressEntityPropertyMap())
            .withPropertyMap(new DeliveryDtoToDeliveryEntityPropertyMap())
            .build();
    }
